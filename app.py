...
if OPENAI_AVAILABLE:
    try:
        ...
        # Initialize with proper configuration for v1.x
        client = OpenAI(
            api_key="eyJhbGciOiJIUzI1NiJ9..WASBTxcAlJhAjWlzdz4Myfa3DRdO8JdlLZsArUuMt10",
