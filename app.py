...
if OPENAI_AVAILABLE:
    try:
        ...
        # Initialize with proper configuration for v1.x
        client = OpenAI(
            api_key="eyJhbGciOiJIUzI1NiJ9..QXTqOt-OEBfmvIanfXiQ4eTLmVXzybqYdz8758Faw5M",
